...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] resourceIDS = this.getArguments()
                .getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS).toArray(new Integer[0]);
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            if (getResultCode() != MainActivity.IS_ALIVE) {
                                ...
                                mContentView.setTextViewText(R.id.text, success ?
                                        successMsg : failMsg);
                                ...
                                mNotificationManager.notify(
                                        MY_NOTIFICATION_ID, notificationBuilder.build());
